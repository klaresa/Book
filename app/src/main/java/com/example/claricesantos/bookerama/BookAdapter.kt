...
import com.example.claricesantos.bookerama.models.Book
...
class BookAdapter(var items: List<Book>):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class BookViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        val titleTextView: TextView = itemView.findViewById(R.id.bookTitle_textView)
        val authorTextView = itemView.findViewById<TextView>(R.id.bookAuthor_textView)
    }
